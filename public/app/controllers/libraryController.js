angular.module('libraryCtrl', [])
  .controller('libraryController', function(){
    ...
    vm.libraryBooks = [
      ...
      {id:'4',book_id:'004',src: 'https://www.smashingmagazine.com/images/book-covers/book-covers-18.jpg',name:'A Clockwork Orange'},
      {id:'5',book_id:'005',src: 'http://cdn2.digitalartsonline.co.uk/cmsdata/news/3280532/Journey-to-the-Centre-of-the-Earth.jpg',name:'Journey to the Center of the Earth'},
      {id:'6',book_id:'006',src: 'http://lovelace-media.imgix.net/uploads/1094/d460f440-6f73-0133-0bb5-0e76e5725d9d.jpg?w=670&fit=max&auto=format&q=70',name:'The Wizard of OZ'},
      {id:'7',book_id:'007',src: 'http://cdn.pastemagazine.com/www/system/images/photo_albums/bestbookcovers/large/the-martian.jpg?1384968217',name:'The Martian'},
      {id:'8',book_id:'008',src: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcT_sMnSRutk9H2zx_7hpJwv658ZgUbaRUFJ_h7fYo93LydERdCx',name:'Alice in Wonderland'},
